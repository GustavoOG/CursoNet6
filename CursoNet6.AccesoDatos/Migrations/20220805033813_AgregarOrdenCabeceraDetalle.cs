...
{
    public partial class AgregarOrdenCabeceraDetalle : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioAplacacionId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UsuararioAplicacionId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.UsuararioAplicacionId,
